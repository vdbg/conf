...
If WScript.Arguments.Count <> 5 And WScript.Arguments.Count <> 4 Then
  WScript.Echo "usage: CreateShortcut.vbs shortcutdir shortcutfile  target workingdir [arguments]"
  WScript.Echo "Argument count: " & WScript.Arguments.Count & ";" & WScript.Arguments.Item(WScript.Arguments.Count -1)
  WScript.Quit
End If
 
set ws = WScript.CreateObject("WScript.Shell")
linkFile = WScript.Arguments.Item(0) & "\" & WScript.Arguments.Item(1) & ".lnk"
